---
title: 'ABI stability'
description: 'Understand what ABI stability means in Node.js, how semantic versioning ensures addon compatibility, and how N-API provides cross-major-version stability for native addons.'
---

## Introduction

An Application Binary Interface (ABI) is a way for programs to call functions and use data structures from other compiled programs. It is the compiled version of an Application Programming Interface (API). In other words, the header files describing the classes, functions, data structures, enumerations, and constants which enable an application to perform a desired task correspond by way of compilation to a set of addresses and expected parameter values and memory structure sizes and layouts with which the provider of the ABI was compiled.
...
<CardGroup cols={1}>
  <Card title="JavaScript language stability vs. native addon maintenance burden">
  ...
  <Card title="Alternative JavaScript runtime implementations">
  ...
  <Card title="Possible future JavaScript engine changes in Node.js">
