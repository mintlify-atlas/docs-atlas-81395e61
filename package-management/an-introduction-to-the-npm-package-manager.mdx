...
description: 'Learn how to use npm to install, update, and manage dependencies in your Node.js projects, and how to run tasks with npm scripts.'
---
...
<Tip>
  [Yarn](https://yarnpkg.com) and [pnpm](https://pnpm.io) are alternatives to the npm CLI. You can check them out as well.
</Tip>
