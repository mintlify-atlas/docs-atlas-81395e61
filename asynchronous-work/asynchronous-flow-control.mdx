...
description: "Learn how to manage asynchronous operations in Node.js using callbacks, serial, parallel, and limited-serial execution patterns."
---

<Note>
The material in this page is heavily inspired by [Mixu's Node.js Book](http://book.mixu.net/node/ch7.html).
</Note>
...
<Warning>
Managing state with global variables is often a sloppy anti-pattern that makes it difficult or impossible to guarantee state. Global variables in complex programs should be avoided when possible.
</Warning>
...
<Tip>
Each pattern has its own use cases, benefits, and issues. Most importantly, remember to modularize your operations and use callbacks! If you feel any doubt, treat everything as if it were middleware.
</Tip>
