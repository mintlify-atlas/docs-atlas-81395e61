...
description: An introduction to testing Node.js code using the built-in test runner, including why testing matters and how to get started.
---
...
There are many test runners available for Node.js, but we will focus on the built-in test runner that comes with Node.js.

<Note>
  You don't need to install any additional dependencies to use Node.js's built-in test runner.
</Note>
