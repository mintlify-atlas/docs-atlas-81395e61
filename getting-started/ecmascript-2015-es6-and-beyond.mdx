...
description: "Learn how Node.js supports modern ECMAScript features through V8, and how to find out which features are available in your Node.js version."
---
...
<CardGroup cols={3}>
  <Card title="Shipping" icon="check-circle">
...
<Warning>
  In progress flags are exposed by V8 and will potentially change without any deprecation notice.
</Warning>
...
<Tip>
  If you want to play safe, especially on production environments, consider removing the `--harmony` runtime flag until the features ship by default on V8 and, consequently, on Node.js. If you keep this enabled, you should be prepared for further Node.js upgrades to break your code if V8 changes their semantics to more closely follow the standard.
</Tip>
