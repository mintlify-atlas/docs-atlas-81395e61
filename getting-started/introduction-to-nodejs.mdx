...
description: "Learn what Node.js is, how it works, and build your first web server application."
---
...
<Tip>
  To run this snippet, save it as a `server.js` file and run `node server.js` in your terminal. If you use the ESM version, save it as `server.mjs` and run `node server.mjs`.
</Tip>
